        ...
        <section>
          ...
          <Card className="p-4 space-y-4">
            ...
            <div className="text-xs text-gray-600">
              ...
              生成按次扣费：2K 每次 10 积分，4K 每次 30 积分；生成失败/取消不扣费。
        ...
        <DialogContent className="max-w-lg max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4 text-sm">
            ...
            <section>
              ...
              <p className="text-gray-600">
                积分用于兑换功能或参与活动（当前为本地演示版，仅保存在本机）。生成按次扣费：2K 每次 10 积分，4K 每次 30 积分；生成失败/取消不扣费。充值档位：9.9 元 = 100 积分，29.9 元 = 300 积分，49.9 元 = 520 积分，99 元 = 1088 积分。你可以在“设置与帮助”的积分模块每日签到，并查看明细与充值。
